...
export type Database = {
  ...
  public: {
    ...
    Views: {
      review_images_public: {
        Row: {
          ...
          moderation_label: string | null;
          moderation_state: Database["public"]["Enums"]["moderation_state"] | null;
    ...
    Enums: {
      ...
      project_status:
        "planned" | "ongoing" | "delayed" | "completed" | "finished_early" | "unknown";
      source_type:
        | "government_portal"
        | "tender_document"
        | "budget_document"
...
export const Constants = {
  public: {
    Enums: {
      ...
      candidate_state: ["discovered", "in_review", "approved", "rejected"],
      moderation_state: ["visible", "held", "blurred", "removed"],
      project_status: ["planned", "ongoing", "delayed", "completed", "finished_early", "unknown"],
      source_type: [
        "government_portal",
        "tender_document",
        "budget_document",
